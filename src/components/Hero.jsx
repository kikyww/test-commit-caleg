...
const Hero = () => {
	return(
		<div className="text-white bg-demokrat">
			<div className="flex flex-col md:flex-row justify-center md:justify-between">	
				<div className="w-full px-6 py-4 font-bold text-lg md:bg-transparent bg-blue-800">
					<h2 className="md:py-8 py-4 font-bold text-2xl text-center">KOMITMEN BERSAMA HENDRAWATI DAN PENDUKUNG</h2>
				</div>
				<div className="md:py-14 w-[400px] md:w-[600px] h-full">
					<div className="group flex flex-col justify-center items-center  md:w-[90%] md:h-[70vh]">
						...
						<img src={Empat} alt="empat" className="absolute z-10  min-[360px]:top-[650px] min-[428px]:top-[650px] right-0 md:top-[470px] md:right-7 w-24 group-hover:scale-110 cursor-pointer transition-all duration-700 ease-in-out" />
